...
parser.add_argument('--sketch_root',default='data/train/video_preprocess/lrs2_sketch128/train',help='root path for sketches')
parser.add_argument('--face_img_root',default='data/train/video_preprocess/lrs2_face128/train',help='root path for face frame images')
parser.add_argument('--audio_root',default='data/train/audio_preprocess/train',help='root path for audio mel')
