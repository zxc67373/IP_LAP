...
parser.add_argument('--pre_audio_root',default='data/train/audio_preprocess/train',
                    help='root path for preprocessed  audio')
parser.add_argument('--landmarks_root',default='data/train/video_preprocess/lrs2_landmarks/train',
    ...
    for epoch in tqdm(range(eval_epochs),total=eval_epochs):
        ...
        for step, (T_mels,T_pose,T_content,Nl_pose,Nl_content) in prog_bar:
            ...
            if random.randint(0,1)==1:
                ...
                predict = draw_(T_pose,predict_content)
                ...
                cv2.imwrite('test_landmark.jpg',drawn_sketech)
