...
parser.add_argument("--data_root", type=str,help="Root folder of the LRS2 dataset", default="data/train/")
parser.add_argument("--out_root", help="output audio root", default='data/train/audio_preprocess')
